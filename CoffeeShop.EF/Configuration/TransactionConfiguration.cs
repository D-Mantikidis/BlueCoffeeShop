...
namespace CoffeeShop.EF.Configuration
{
    internal class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
    {
        public void Configure(EntityTypeBuilder<Transaction> builder)
        {
            ...
            builder.HasMany(transaction => transaction.TransactionLines).WithOne(transactionline => transactionline.Transaction).HasForeignKey(transactionLine => transactionLine.TransactionID).IsRequired();
        }
    }
}
